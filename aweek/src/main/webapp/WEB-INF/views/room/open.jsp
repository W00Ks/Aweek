...
.container__right .open-content .object:nth-child(6) input {
	width: 20px;
}
			...
			<div class="open-content">
				...
				<div class="object"> 
			    	...
			    	<div class="roomPublic-section">
				    	<input type="radio" name="roomPublic" value="1"  id="roomPublicY" checked><div class="public-content">공개</div>
				    	<input type="radio" name="roomPublic" value="0" id="roomPublicN"><div class="public-content">비공개</div>
			    	</div>
			    </div>

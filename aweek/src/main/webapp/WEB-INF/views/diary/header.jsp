...
$(document).ready(function(){
	...
	$(".writediary1").click(function(){
		if(!$('input:radio[name=roomNo]').is(':checked')){
			alert("모임을 선택해 주세요.");
			return false;
		}
				...
				<ul>
					<c:forEach items="${diaryFavorite }" var="data">
						<li class="menu">
							...
							<ul class="hide">
								<li><div class="menublock2"><a href="./notice?roomNo=${data.roomNo }"><img class="submenu1" alt="" src="/resources/diary/submenu1.PNG" style="float: left; margin-top: 3px;"><img class="submenu2" alt="" src="/resources/diary/submenu2.PNG" style="float: left; margin-top: 3px;"><div style="padding-left: 20px; font-size: 0.9em; color: black; line-height: 19px;">공지사항</div></a></div></li>
								<li><div class="menublock2"><a href="./best?roomNo=${data.roomNo }"><img class="submenu1" alt="" src="/resources/diary/submenu1.PNG" style="float: left; margin-top: 3px;"><img class="submenu2" alt="" src="/resources/diary/submenu2.PNG" style="float: left; margin-top: 3px;"><div style="padding-left: 20px; font-size: 0.9em; color: black; line-height: 19px;">추천글</div></a></div></li>
								<li><div class="menublock2"><a href="./entire?roomNo=${data.roomNo }"><img class="submenu1" alt="" src="/resources/diary/submenu1.PNG" style="float: left; margin-top: 3px;"><img class="submenu2" alt="" src="/resources/diary/submenu2.PNG" style="float: left; margin-top: 3px;"><div style="padding-left: 20px; font-size: 0.9em; color: black; line-height: 19px;">전체글</div></a></div></li>
							</ul>
						</li>
					</c:forEach>
				</ul>
            ...
            <div class="content">
            	<form action="./write" method="get" class="writediary2">
					<ul>
						<br>
						<c:forEach items="${userRoom }" var="data">
							<label for='select${data.roomNo }'><div style="width: 100%; cursor: pointer; margin-bottom: 10px;" class="selectroomNo"><input type='radio' name='roomNo' id='select${data.roomNo }' value='${data.roomNo }' />&nbsp;${data.roomName }</div></label>
						</c:forEach>
					</ul>
				</form>
            </div>

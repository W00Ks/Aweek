...
<br>
<div class="rightbox3">
	<div style="font-size: 1.2em; font-weight:600;">공지사항<a href="./notice" style="cursor: pointer;"><div style="float: right; font-size: 0.7em; font-weight:400; color: black;">더보기<img alt="" src="/resources/diary/submenu1.PNG" style="float: right; margin: 0px 3px;"></div></a></div>
	<hr>
	...
	<tr onclick="location.href='./view?diaryNo=${Notice.diaryNo }'" style="display: inline-block; cursor: pointer;">
		<td style="width: 90px;">${Notice.roomName }</td>
		<td style="width: 40%; font-weight: 600;">${Notice.diaryTitle }</td>
		<td style="width: 90px;">${Notice.userName }</td>
		<td style="width: 90px;"><fmt:formatDate value="${Notice.diaryDate }" pattern="yyyy-MM-dd"/></td>
		<td style="width: 90px;">조회수 ${Notice.diaryHit }</td>
	</tr>
	</c:forEach>
	</table>		
</div>
<div class="rightbox4">
	<div style="font-size: 1.2em; font-weight:600;">추천글<a href="./best" style="cursor: pointer;"><div style="float: right; font-size: 0.7em; font-weight:400; color: black;">더보기<img alt="" src="/resources/diary/submenu1.PNG" style="float: right; margin: 0px 3px;"></div></a></div>
	<hr>
	<table class="table table-striped table-hover table-condensed">
	...
	<tr onclick="location.href='./view?diaryNo=${Recomm.diaryNo }'" style="display: inline-block; cursor: pointer;">
		<td style="width: 90px;">${Recomm.roomName }</td>
		<td style="width: 90px;">${Recomm.diaryCateName }</td>
		<td style="width: 25%; font-weight: 600;">${Recomm.diaryTitle }</td>
		<td style="width: 90px;">${Recomm.userName }</td>
		<td style="width: 90px;"><fmt:formatDate value="${Recomm.diaryDate }" pattern="yyyy-MM-dd"/></td>
		<td style="width: 90px;">추천수 ${Recomm.diaryRecommend }</td>
	</tr>
	</c:forEach>
	</table>
</div>
<div class="rightbox5">
	<div style="font-size: 1.2em; font-weight:600;">전체글<a href="./entire" style="cursor: pointer;"><div style="float: right; font-size: 0.7em; font-weight:400; color: black;">더보기<img alt="" src="/resources/diary/submenu1.PNG" style="float: right; margin: 0px 3px;"></div></a></div>
	<hr>
	<table class="table table-striped table-hover table-condensed">
	...
	<tr onclick="location.href='./view?diaryNo=${Current.diaryNo }'" style="display: inline-block; cursor: pointer;">
		<td style="width: 90px;">${Current.roomName }</td>
		<td style="width: 90px;">${Current.diaryCateName }</td>
		<td style="width: 25%; font-weight: 600;">${Current.diaryTitle }</td>
		<td style="width: 90px;">${Current.userName }</td>
		<td style="width: 90px;"><fmt:formatDate value="${Current.diaryDate }" pattern="yyyy-MM-dd"/></td>
		<td style="width: 90px;">조회수 ${Current.diaryHit }</td>
	</tr>
	</c:forEach>
	</table>
</div>
